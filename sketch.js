...
function setup(){
  ...
  //  Playertest = Bodies.rectangle(500,200,200,200);
  //  World.add(world,Playertest);
}

function draw(){
    background(232,160,200);
    Engine.update(engine);
  //  createSprite(Playertest.position.x,Playertest.position.y,200,200)
    if(gameState===10){
        imageMode(CENTER);
...
/*function keyPressed(){
    if(keyCode===UP_ARROW){
        console.log("hi");
      Matter.Body.applyForce(player1.body,player1.body.position,{x:7,y:10})
